...
import (
	...
	"github.com/OlesNikon/social/docs" // This is required for swagger docs
...
func (app *application) mount() http.Handler {
	...
	r.Use(cors.Handler(cors.Options{
		AllowedOrigins: []string{
			...
			"http://localhost:5174", // Add additional port for when 5173 is in use
		},
...
func (app *application) run(mux http.Handler) error {
	...
	app.logger.Infow("server has started on", "addr", app.config.addr, "env", app.config.env)
